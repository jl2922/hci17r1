...
class Parallel {
 public:
  ...
  virtual void reduce_to_sum_vector(std::vector<unsigned long long>& value) = 0;

  virtual void reduce_to_sum_vector(std::vector<double>& value) = 0;

  virtual void reduce_to_sum_vector(std::vector<long double>& value) = 0;
};
